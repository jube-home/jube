...
namespace Jube.App.Controllers.Repository
{
    ...
    public class EntityAnalysisModelProcessingCounterController : Controller
    {
        ...
        private readonly EntityAnalysisModelProcessingCounterRepository _repository;
            ...
            IHttpContextAccessor httpContextAccessor,DynamicEnvironment.DynamicEnvironment dynamicEnvironment)
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<EntityAnalysisModelProcessingCounterDto,
                    EntityAnalysisModelProcessingCounter>();
        ...
        public ActionResult<List<EntityAnalysisModelProcessingCounterDto>> Get()
        {
            try
            {
                ...
                return Ok(_mapper.Map<List<EntityAnalysisModelProcessingCounterDto>>(_repository.Get(60)));
            }
            catch (Exception e)
            {
                _log.Error(e);
