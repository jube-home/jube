...
namespace Jube.App.Controllers.Query
{
    ...
    public class GetExhaustiveSearchInstancePromotedTrialInstanceErrorHistogramController : Controller
    {
        ...
        private readonly GetExhaustiveSearchInstancePromotedTrialInstanceErrorHistogramQuery _query;
            ...
            IHttpContextAccessor httpContextAccessor,DynamicEnvironment.DynamicEnvironment dynamicEnvironment)
        {
            ...
            _query = new GetExhaustiveSearchInstancePromotedTrialInstanceErrorHistogramQuery(_dbContext, _userName);
        }
