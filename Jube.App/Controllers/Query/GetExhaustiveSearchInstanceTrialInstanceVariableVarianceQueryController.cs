...
namespace Jube.App.Controllers.Query
{
    ...
    public class GetExhaustiveSearchInstanceTrialInstanceVariableVarianceQueryController : Controller
    {
        ...
        private readonly GetExhaustiveSearchInstanceVariableVarianceQuery _query;
            ...
            ,IHttpContextAccessor httpContextAccessor,DynamicEnvironment.DynamicEnvironment dynamicEnvironment)
        {
            ...
            _query = new GetExhaustiveSearchInstanceVariableVarianceQuery(_dbContext, _userName);
        }
        ...
        [HttpGet("{id:int}")]
        public ActionResult<List<GetExhaustiveSearchInstanceVariableVarianceQuery.Dto>> Get(int id)
        {
            try
            {
