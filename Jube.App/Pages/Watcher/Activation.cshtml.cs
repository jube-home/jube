...
namespace Jube.App.Pages.Watcher
{
    [Authorize]
    public class Activation : PageModel
    {
        ...
        public Activation(ILog log, DynamicEnvironment.DynamicEnvironment dynamicEnvironment, IHttpContextAccessor httpContextAccessor)
        {
