...
{
    public class EntityAnalysisModelAdaptationDtoValidator : AbstractValidator<EntityAnalysisModelAdaptationDto>
    {
        public EntityAnalysisModelAdaptationDtoValidator()
        {
