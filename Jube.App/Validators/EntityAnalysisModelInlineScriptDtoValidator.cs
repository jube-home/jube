...
{
    public class EntityAnalysisModelInlineScriptDtoValidator : AbstractValidator<EntityAnalysisModelInlineScriptDto>
    {
        public EntityAnalysisModelInlineScriptDtoValidator()
        {
            ...
            RuleFor(p => p.EntityAnalysisInlineScriptId).NotEmpty();
        }
    }
}