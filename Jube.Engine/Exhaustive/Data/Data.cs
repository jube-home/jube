...
namespace Jube.Engine.Exhaustive.Data
{
    ...
    {
        public static async Task<Tuple<double[][],double[]>> GetClassData(DbContext dbContext,
            ...
            bool mockData)
        {
            ...
            foreach (var json in
                await postgres.ExecuteReturnOnlyJsonFromArchiveSample(entityAnalysisModelId, filterSql, filterTokens, 10000,mockData))
            {
        ...
        public static async Task<Tuple<Dictionary<int, Variable>,double[][]>> GetSampleData(DbContext dbContext, 
            int tenantRegistryId,
            int entityAnalysisModelId,
            string filterSql,
            string filterTokens,
        ...
        {
            var postgres = new Postgres(dbContext.ConnectionString);
            var jsonList = await postgres.ExecuteReturnOnlyJsonFromArchiveSample(entityAnalysisModelId,
                "NOT (" + filterSql + ")",
