...
namespace Accord.Math.Decompositions
{
    ...
    ///    
    [Serializable]
    public sealed class CholeskyDecompositionD : ICloneable, ISolverMatrixDecomposition<Decimal>
    {
        ...
        /// 
        public CholeskyDecompositionD(Decimal[,] value, bool robust = false, 
        ...
        {
            return Solve(Matrix.Identity<Decimal>(n));
        }
        ...
        private CholeskyDecompositionD()
        {
        }
