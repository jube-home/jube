...
namespace Jube.Data.Repository
{
    public class CaseWorkflowActionRepository
    {
        ...
        {
            return _dbContext.CaseWorkflowAction
        ...
        public IEnumerable<CaseWorkflowAction> GetByCasesWorkflowId(int casesWorkflowId)
        {
            return _dbContext.CaseWorkflowAction
                .Where(w => w.CaseWorkflow.EntityAnalysisModel.TenantRegistryId == _tenantRegistryId
        ...
        {
            return _dbContext.CaseWorkflowAction.FirstOrDefault(w =>
        ...
        {
            var existing = _dbContext.CaseWorkflowAction
        ...
        {
            var records = _dbContext.CaseWorkflowAction
