...
namespace Jube.Data.Repository
{
    public class EntityAnalysisModelListRepository
    {
        ...
        public IEnumerable<EntityAnalysisModelList> GetByEntityAnalysisModelId(int entityAnalysisModelId)
        {
            return _dbContext.EntityAnalysisModelList
                .Where(w =>
                    (w.EntityAnalysisModel.TenantRegistryId == _tenantRegistryId || !_tenantRegistryId.HasValue)
        ...
        public EntityAnalysisModelList Update(EntityAnalysisModelList model)
        {
            ...
            foreach (var entityAnalysisModelsListValue in
                _dbContext.EntityAnalysisModelListValue
                    .Where(w => w.EntityAnalysisModelListId == existing.Id
                                && (w.Deleted == 0 || w.Deleted == null)).ToList())
            {
                entityAnalysisModelsListValue.EntityAnalysisModelListId = id;
