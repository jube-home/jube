...
namespace Jube.Data.Repository
{
    public class EntityAnalysisModelInlineScriptRepository
    {
        ...
        public IEnumerable<EntityAnalysisModelInlineScript> Get()
        {
            return _dbContext.EntityAnalysisModelInlineScript
                .Where(w => w.EntityAnalysisModel.TenantRegistryId == _tenantRegistryId || !_tenantRegistryId.HasValue);
        }

        public IEnumerable<EntityAnalysisModelInlineScript> GetByEntityAnalysisModelId(int entityAnalysisModelId)
        {
            return _dbContext.EntityAnalysisModelInlineScript
                .Where(w => (w.EntityAnalysisModel.TenantRegistryId == _tenantRegistryId || !_tenantRegistryId.HasValue)
        ...
        public EntityAnalysisModelInlineScript GetById(int id)
        {
            return _dbContext.EntityAnalysisModelInlineScript.FirstOrDefault(w =>
                (w.EntityAnalysisModel.TenantRegistryId == _tenantRegistryId || !_tenantRegistryId.HasValue)
                && w.Id == id && (w.Deleted == 0 || w.Deleted == null));
        }

        public EntityAnalysisModelInlineScript Insert(EntityAnalysisModelInlineScript model)
        {
        ...
        public EntityAnalysisModelInlineScript Update(EntityAnalysisModelInlineScript model)
        {
            var existing = _dbContext.EntityAnalysisModelInlineScript
        ...
        {
            var records = _dbContext.EntityAnalysisModelInlineScript
                .Where(d =>
