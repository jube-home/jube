...
namespace Jube.Data.Repository
{
    public class CaseWorkflowFilterRepository
    {
        ...
        {
            return _dbContext.CaseWorkflowFilter
                .Where(w => w.CaseWorkflow.EntityAnalysisModel.TenantRegistryId == _tenantRegistryId);
        }

        public IEnumerable<CaseWorkflowFilter> GetByCasesWorkflowId(int casesWorkflowId)
        {
            return _dbContext.CaseWorkflowFilter
                .Where(w => w.CaseWorkflow.EntityAnalysisModel.TenantRegistryId == _tenantRegistryId
        ...
        {
            return _dbContext.CaseWorkflowFilter.FirstOrDefault(w =>
        ...
        {
            var existing = _dbContext.CaseWorkflowFilter
        ...
        {
            var records = _dbContext.CaseWorkflowFilter
