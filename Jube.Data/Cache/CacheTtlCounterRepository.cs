...
namespace Jube.Data.Cache
{
    ...
    {
        public async Task DecrementTtlCounterCache(int entityAnalysisModelId, int entityAnalysisModelTtlCounterId,
        ...
        public async Task<DateTime?> GetMostRecentFromTtlCounterCache(int entityAnalysisModelId, int entityAnalysisModelTtlCounterId,
            string dataName)
        {
            var connection = new NpgsqlConnection(connectionString);
            DateTime? value = null;
        ...
        public async Task<int> GetByNameDataNameDataValue(int entityAnalysisModelId, int entityAnalysisModelTtlCounterId, string dataName, string dataValue)
        {
            var connection = new NpgsqlConnection(connectionString);
            var value = 0;
            try
        ...
        public async Task Upsert(int entityAnalysisModelId, string dataName, string dataValue, int entityAnalysisModelTtlCounterId,
