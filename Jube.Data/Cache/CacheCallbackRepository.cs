...
namespace Jube.Data.Cache
{
        ...
        ConcurrentDictionary<Guid, Callback> concurrentDictionary)
    {
        ...
        public async Task ListenForCallbacks()
        {
        ...
        public async Task Insert(byte[] json, Guid entityAnalysisModelInstanceEntryGuid)
        {
            var connection = new NpgsqlConnection(connectionString);
            try
            {
        ...
        public async Task Delete(Guid entityAnalysisModelInstanceEntryGuid)
        {
            var connection = new NpgsqlConnection(connectionString);
            try
            {
