...
namespace Jube.Data.Cache
{
    ...
    {
        public async Task<CacheSanctionDto> GetByMultiPartStringDistanceThreshold(int entityAnalysisModelId, string multiPartString,
        ...
        public async Task Insert(int entityAnalysisModelId, string multiPartString,
        ...
        public async Task Update(long id, double? value)
        {
            var connection = new NpgsqlConnection(connectionString);
            try
            {
