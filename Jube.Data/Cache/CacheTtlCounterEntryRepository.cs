...
namespace Jube.Data.Cache
{
    ...
    {
        public async Task DeleteAfterDecremented(int entityAnalysisModelId, int entityAnalysisModelTtlCounterId,
        ...
        public async Task<Dictionary<string, int>> GetExpiredTtlCounterCacheCounts(int entityAnalysisModelId, int entityAnalysisModelTtlCounterId,
            string dataName, DateTime referenceDate)
        {
            var connection = new NpgsqlConnection(connectionString);
        ...
        public async Task<Dictionary<string, int>> GetByNameDataNameDataValue(int entityAnalysisModelId,
        ...
        public async Task Insert(int entityAnalysisModelId, string dataName, string dataValue, int entityAnalysisModelTtlCounterId,
