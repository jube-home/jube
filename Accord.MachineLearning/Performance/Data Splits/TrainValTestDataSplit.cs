...
namespace Accord.MachineLearning.Performance
{
    ...
    /// 
    public class TrainValTestDataSplit<TInput, TOutput> : TrainValTestSplit<DataSubset<TInput, TOutput>>, IDataSplit<TInput, TOutput>
    {
        /// <summary>
        ...
        /// 
        public TrainValTestDataSplit(int index, TInput[] inputs, TOutput[] outputs, double[] weights, 
            int[] trainIndices, int[] validationIndices, int[] testingIndices)
        {
            ...
            this.Testing = new DataSubset<TInput, TOutput>(index, inputs, outputs, weights, testingIndices);
        }
    }
}
