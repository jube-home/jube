...
namespace Accord.MachineLearning.Performance
{
    ...
    /// 
    public class TrainTestDataSplit<TInput, TOutput> : TrainTestSplit<DataSubset<TInput, TOutput>>, IDataSplit<TInput, TOutput>
    {
        /// <summary>
        ...
        /// 
        public TrainTestDataSplit(int index, TInput[] inputs, TOutput[] outputs, double[] weights, int[] trainIndices, int[] testIndices)
        {
            this.SplitIndex = index;
            this.Training = new DataSubset<TInput, TOutput>(index, inputs, outputs, weights, trainIndices);
            this.Testing = new DataSubset<TInput, TOutput>(index, inputs, outputs, weights, testIndices);
        }
    }
}
