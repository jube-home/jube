...
{
    [Migration(20220429124928)]
    public class AddEntityAnalysisModelDictionaryCsvFileUploadTable : Migration
    {
        public override void Up()
        {
            Create.Table("EntityAnalysisModelDictionaryCsvFileUpload")
